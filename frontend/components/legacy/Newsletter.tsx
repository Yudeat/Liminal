        ...
        <div className="bg-white/[0.03] border border-white/8 rounded-3xl p-8 md:p-14 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10">
            ...
            <div className="max-w-lg text-center lg:text-left space-y-3">
              <div className="inline-block px-3 py-1 bg-white/8 border border-white/10 text-[10px] font-black uppercase tracking-[0.25em] text-white/60 rounded-lg">
                The Dispatch
              </div>
            ...
            <div className="w-full max-w-md">
              <form className="flex flex-col sm:flex-row gap-2.5" onSubmit={(e) => e.preventDefault()}>
                <input
                  ...
                  className="flex-grow px-5 py-3.5 rounded-xl text-sm font-medium bg-white/5 border border-white/10 text-white outline-none focus:border-white/25 focus:ring-4 focus:ring-white/5 transition-all placeholder:text-white/35"
                />
              ...
              <p className="mt-3 text-[10px] font-bold uppercase tracking-widest text-white/45 text-center lg:text-left ml-1">
                No spam. Just{" "}
                <span className="text-white/65">Exile</span> logic.
              </p>
            </div>
          </div>
        </div>
