  ...
  return (
    <div className="relative min-h-screen w-full bg-black text-white">
      ...
      <div className="relative z-10">
        ...
        <header className="flex flex-col items-center justify-center text-center px-4 pt-52 pb-20">
          <h1 className="text-xl md:text-5xl font-black tracking-tighter mb-6 bg-clip-text text-transparent bg-gradient-to-b from-pink-600 to-gray-500">
          ...
          <p className="max-w-2xl text-lg md:text-xl text-gray-400 mb-10">
           Liminal replaces confusing consultancy processes with a transparent system that
            checks your eligibility, verifies your documents, and guides every step — while you stay in charge of submission.          </p>
          <button className="px-8 py-4 bg-[#bf00ff] text-[#2cff05] font-bold rounded-full hover:bg-pink-400 transition-colors">
            Get Started
          </button>
        </header>
